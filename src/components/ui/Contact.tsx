...
export const Contact = () => {
  ...
  const themeValidation = mode === 'light' ? 'contact__font-light' : 'contact__font-dark';
  const themeValidationDrk = mode === 'dark' && 'contact__dark';

  return (
    <div className={ `${themeValidationDrk} contact__container--font ${ themeValidation }` } id="contact">
